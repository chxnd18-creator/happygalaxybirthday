(function(window){
    ...
    Seed = function(tree, point, scale, color) {
        ...
        var scale = scale || 1
        var color = color || 'rgb(255, 105, 180)';
    ...
    Seed.prototype = {
        ...
        drawText: function() {
            ...
            ctx.fillText("love letter", 23, 16);
            ctx.restore();
        },
        clear: function() {
            var ctx = this.tree.ctx, cirle = this.cirle;
    ...
    Footer.prototype = {
        draw: function() {
            ...
            ctx.save();
            ctx.strokeStyle = 'rgb(180, 60, 100)';
    ...
    Tree.prototype = {
        initSeed: function() {
            ...
            var color = seed.color || 'rgb(255, 105, 180)';
    ...
    Branch.prototype = {
        ...
        draw: function(p) {
            ...
            ctx.shadowColor = 'rgb(255, 150, 180)';
   ...
   Bloom = function(tree, point, figure, color, alpha, angle, scale, place, speed) {
        ...
        var colorType = random(1, 5);
        var r, g, b;
        if (colorType === 1) {
            r = 220; g = 20; b = 80;    // ชมพูเข้มสด
        } else if (colorType === 2) {
            r = 240; g = 50; b = 100;   // ชมพูเข้มอมแดง
        } else if (colorType === 3) {
            r = 255; g = 255; b = 255;  // ขาว
        } else if (colorType === 4) {
            r = 255; g = 240; b = 245;  // ขาวอมชมพู
        } else {
            r = 200; g = 0; b = 70;     // ชมพูเข้มเลือด
        }
